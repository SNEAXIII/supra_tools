...
class balle:
    ...
    def h(self, brique):
        pygame.draw.circle(self.surface, (0, 0, 255), (int(1080 / 2), (brique.y_max - self.vy - 1)), 2)
        pygame.draw.circle(self.surface, (0, 0, 255), (int(1080 / 2), brique.y_max), 2)
        pygame.draw.circle(self.surface, (0, 0, 255), (int(1080 / 2), (self.y - self.rayon)), 2)

    def h1(self, brique):
        pygame.draw.circle(self.surface, (0, 255, 0), (int(1080 / 2), (brique.y_min + self.vy + 1)), 2)
        pygame.draw.circle(self.surface, (0, 255, 0), (int(1080 / 2), brique.y_min), 2)
        pygame.draw.circle(self.surface, (0, 255, 0), (int(1080 / 2), (self.y + self.rayon)), 2)

    def l(self, brique):
        pygame.draw.circle(self.surface, (255, 0, 0), (brique.x_min + abs(self.vx) + 1, int(720 / 2)), 2)
        pygame.draw.circle(self.surface, (0, 255, 0), (self.x + self.rayon, brique.y_min), 2)
        pygame.draw.circle(self.surface, (0, 255, 0), (brique.x_min, int(720 / 2)), 2)

    def x_(self):
        pygame.draw.circle(self.surface, (0, 0, 255), (self.x, self.Barre.y), 6)
